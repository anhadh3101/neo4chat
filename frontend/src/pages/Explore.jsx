...
import { searchUsers, getFriendRecommendations, getPopularUsers } from '@/lib/api';
...
function PopularColumn() {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <CardContent className="flex-1 overflow-y-auto">
        {loading ? (
          <p className="text-sm text-muted-foreground">Loading popular users...</p>
        ) : popularUsers.length === 0 ? (
          <p className="text-sm text-muted-foreground">No popular users available.</p>
        ) : (
